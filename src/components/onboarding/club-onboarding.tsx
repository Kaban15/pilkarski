            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <Link href="/sparings/new" className="group">
                  <Card className="h-full border-2 border-emerald-200 transition-all hover:border-emerald-400 dark:border-emerald-800 dark:hover:border-emerald-600">
                ...
                <Link href="/events/new" className="group">
                  <Card className="h-full border-2 border-violet-200 transition-all hover:border-violet-400 dark:border-violet-800 dark:hover:border-violet-600">
                    <CardContent className="flex flex-col items-center gap-3 py-8 text-center">
